...
class PickerDialog: UIView {
    ...
    public typealias PickerCallback = (String? ) -> Void
    ...
    func show(title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", options: [[String: String]], selected: String? = nil, callback: @escaping @escaping @escaping PickerCallback) {
